...
--
-- Реальные данные противоречивы, поэтому взять их нельзя: по файлам
-- Messeleitung в зале 27 площадок, но прайс и план расходятся — H20 в прайсе
-- 5×3, на плане 13×5; H24 в прайсе 20 м², на плане 10×7; H26 в прайсе 120 м²,
-- на плане 20 м², а 120 м² — это H27, которого в прайсе нет вовсе.
--
